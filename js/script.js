...
(function($) {
    ...
    let career = $('.career-wrapper')
    let skills = $('.skills-wrapper')
        ...
        animate: function() {
            ...
            function closeAnimation2() {
                TweenMax.to(skills, 1.2, {
                    ...
                    onComplete: function() {
                        TweenMax.to(portfolioContainer, 0.8, {
                            height: "100%",
                            ease: ITEManimate.bezier(0.815, 0.035, 0.350, 0.930),
                            top: "0%",
                            ease: ITEManimate.bezier(0.815, 0.035, 0.350, 0.930),
            ...
            animationTrigger.click(function() {
                if ($(this).attr('data-toggle') == "0") {
                    ...
                    closeAnimation1()
                } else if($(this).attr("data-toggle") == "1-back"){
                    closeAnimation11()
                } else if ($(this).attr('data-toggle') == "2") {
                    closeAnimation2();
                } else if($(this).attr("data-toggle") == "2-back"){
                    closeAnimation21()
                }else if ($(this).attr('data-toggle') == "end") {
                    closeAnimation();
                }
            });
        }
